...
// ***********************************************************************
//  <copyright file="IsReproduciableSpecification.cs" company="Ajay Singh">
...
namespace GameOfLife.Core.Specifications
{
    ...
    public class IsReproduciableSpecification : ISpecification<ICell>
    {
        ...
        public IsReproduciableSpecification(IGrid grid)
        {
            _grid = grid;
        ...
        public bool IsSatisfiedBy(ICell currentCell)
        {
            ...
            return (currentCell.Alive == false && aliveNeighbours.Count == 3);
        }

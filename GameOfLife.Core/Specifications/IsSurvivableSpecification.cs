...
// ***********************************************************************
//  <copyright file="IsSurvivableSpecification.cs" company="Ajay Singh">
...
namespace GameOfLife.Core.Specifications
{
    ...
    /// </summary>
    public class IsSurvivableSpecification : ISpecification<ICell>
    {
        private readonly IGrid _grid;
        private readonly INeighbour _neighbour;

        public IsSurvivableSpecification(IGrid grid)
        {
            _grid = grid;
